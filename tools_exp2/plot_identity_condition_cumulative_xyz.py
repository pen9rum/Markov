...
Same visual style as tools_exp3/plot_identity_condition_cumulative.py.
...
Output: exp2(generation_blind)/plots/
          ...
          identity_condition_{metric}cum_by_model.png  (4 files)

Usage:
  python tools_exp2/plot_identity_condition_cumulative_xyz.py
"""
import os
import csv
