...
def plot_distribution(slump_csv, outdir):
    ...
    axes[0].bar([i - width / 2 for i in x], ce_c, width=width, label='Identity Correct', color='#2E86DE')
    axes[0].bar([i + width / 2 for i in x], ce_w, width=width, label='Identity Wrong', color='#E74C3C')
    ...
    axes[1].bar([i - width / 2 for i in x], mse_c, width=width, label='Identity Correct', color='#2E86DE')
    axes[1].bar([i + width / 2 for i in x], mse_w, width=width, label='Identity Wrong', color='#E74C3C')
...
def plot_markov(slump_csv, outdir):
    ...
    axes[0].bar(groups, exact_vals, color=['#2E86DE', '#E74C3C'])
    ...
    axes[1].bar(groups, strict_vals, color=['#2E86DE', '#E74C3C'])
    axes[1].set_title('Markov Player — Strict Exact Match (All-or-Nothing)')
    axes[1].set_ylabel('Rate')
    axes[1].set_ylim(0.0, 1.0)
    axes[1].grid(axis='y', alpha=0.3)

    for ax, vals in zip(axes, [exact_vals, strict_vals]):
        for i, v in enumerate(vals):
    ...
    axes[0].bar([i - width / 2 for i in x], exact_c, width=width, label='Identity Correct', color='#2E86DE')
    axes[0].bar([i + width / 2 for i in x], exact_w, width=width, label='Identity Wrong', color='#E74C3C')
    ...
    axes[1].bar([i - width / 2 for i in x], strict_c, width=width, label='Identity Correct', color='#2E86DE')
    axes[1].bar([i + width / 2 for i in x], strict_w, width=width, label='Identity Wrong', color='#E74C3C')
