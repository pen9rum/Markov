...
def main():
    ...
    axes[2].set_title('Model Comparison — Markov Overlap Rate', fontsize=12, fontweight='bold')
    ...
    axes[3].set_title('Model Comparison — Markov Exact Match', fontsize=12, fontweight='bold')
